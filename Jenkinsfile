...
(script: 'curl -s http://192.168.33.10:8081/repository/maven-snapshots/tn/esprit/ds/SkiStationProject/0.0.1-SNAPSHOT/maven-metadata.xml | grep -oP "(?<=<value>)[^<]+"', returnStdout: true).trim()
