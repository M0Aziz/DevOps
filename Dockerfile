...
#ARG BUILD_NUMBER
ARG VERSION
ADD http://192.168.33.10:8081/repository/maven-snapshots/tn/esprit/ds/SkiStationProject/0.0.1-SNAPSHOT/SkiStationProject-${VERSION}.jar SkiStationProject.jar
